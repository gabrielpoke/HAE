...
<body>
    ...
    ?>
    <form action="../_html/novoUsuario.html" method="post" id="novoUsuario" name="newUser">
      <input type="submit" name="submit" value="Cadastrar Usuário" class="txt2" method="post">
    </form>
    </center>     
